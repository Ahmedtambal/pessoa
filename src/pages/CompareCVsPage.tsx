    ...
    <div className="mt-8 pt-6 border-t border-white/10 animate-fade-in">
      <div className="result-card space-y-8">
        {parsedContent.length === 0 ? (
          // Simple fallback: show the raw AI output in a preformatted block to
          // preserve tables, pipes and newlines so the output looks tidy and
          // user-friendly when the AI didn't use headings.
