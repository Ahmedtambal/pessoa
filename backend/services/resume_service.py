...
1.  **NO BOLD TEXT OR EMPHASIS:** Your entire response must be in plain text. You MUST NOT use asterisks (`**`) or any other characters for bolding or emphasis. This is a non-negotiable rule for all parts of your output.
2.  You MUST produce exactly three sections, each with a specific heading.
3.  All tables must be in valid Markdown format.
...
- The table columns MUST be: `Applicant`, `Overall Score (/100)`, `Key Strengths`, `Potential Gaps`.

**PART 2: COMPARATIVE ANALYSIS**
- Create a Markdown table comparing the top applicants against each other on key criteria.
- The table columns MUST be: `Criterion`, `[Applicant 1 Name]`, `[Applicant 2 Name]`, `[etc...]`.

**PART 3: FINAL RECOMMENDATION**
- Write a concluding paragraph starting with "## Final Recommendation".
- State which candidate is the best fit for the role and provide a clear, concise justification. The candidate's name MUST be written in plain text, without bolding or any other emphasis.
